...
class Ui_GenerateDeleteKeysWindow(object):
    def setupUi(self, GenerateDeleteKeysWindow):
        ...
        self.menubar = QMenuBar(GenerateDeleteKeysWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 800, 37))
        GenerateDeleteKeysWindow.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(GenerateDeleteKeysWindow)
        self.statusbar.setObjectName(u"statusbar")
        GenerateDeleteKeysWindow.setStatusBar(self.statusbar)
    ...
    def retranslateUi(self, GenerateDeleteKeysWindow):
        GenerateDeleteKeysWindow.setWindowTitle(QCoreApplication.translate("GenerateDeleteKeysWindow", u"MainWindow", None))
    # retranslateUi
